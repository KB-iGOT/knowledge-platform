...
class TestHierarchy extends BaseSpec {
    ...
    private val script_6 = "INSERT INTO hierarchy_store.content_hierarchy(identifier, hierarchy, relational_metadata) values ('do_26543193441064550414', '{\"identifier\":\"do_26543193441064550414\",\"children\":[{\"parent\":\"do_26543193441064550414\",\"identifier\":\"do_11283193463014195215\",\"copyright\":\"Sunbird\",\"lastStatusChangedOn\":\"2019-08-21T14:37:50.281+0000\",\"code\":\"2e837725-d663-45da-8ace-9577ab111982\",\"visibility\":\"Parent\",\"index\":1,\"mimeType\":\"application/vnd.ekstep.content-collection\",\"createdOn\":\"2019-08-21T14:37:50.281+0000\",\"versionKey\":\"1566398270281\",\"framework\":\"tpd\",\"depth\":1,\"children\":[],\"name\":\"U1\",\"lastUpdatedOn\":\"2019-08-21T14:37:50.281+0000\",\"contentType\":\"CourseUnit\",\"status\":\"Draft\", \"objectType\":\"Collection\"}]}','{\"do_26543193441064550414\": {\"name\": \"Collection Publish T21\", \"children\": [\"do_11283193463014195215\"], \"root\": true}, \"do_11283193463014195215\": { \"name\": \"Collection Parent\", \"children\": [ \"do_113193433773948928111\" ], \"root\": false, \"relationalMetadata\": { \"do_113193433773948928111\": { \"name\": \"Test Name RM L1 - R1\", \"keywords\": [ \"Overwriting content KW1\" ] } } }, \"do_113193433773948928111\": { \"name\": \"PDF Content\", \"children\": [], \"root\": false }}');"
    ...
    "addLeafNodesToHierarchy" should "addLeafNodesToHierarchy" in {
        ...
        request.put("relationalMetadata",JavaConverters.mapAsJavaMap(Map("do_11340096165525094411" -> Map("relName" -> "Test Name RM", "keywords" -> Array("Overwriting content Keywords") ))))
